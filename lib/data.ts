  ...
  return [
    {
      ...
      description: [t("master.description.0"), t("master.description.1"), t("master.description.2"), t("master.description.3")],
    ...
    },
    {
      ...
      description: [t("bachelor.description.0"), t("bachelor.description.1")],
      cta: { title: t("bachelor.cta"), link: "/project/trilum" },
...
export const getProjectsData = (theme: string, t: (key: string) => string) => {
  return [
    ...
    },
    {
      ...
      tags: ["NestJs", "TypeORM", "JWT","Vue.js", "Pinia", "Figma", "Adobe InDesign"],
      image: bevry,
    ...
    },
    {
      ...
      tags: ["React Native", "Expo", "NFC", "Bluetooth Low Energy", "Figma"],
      image: timeparabox,
    ...
    },
    {
      ...
      tags: ["Vue.js", "Pinia", "Vite", "Java", "Spring Boot", "Maven", "API"],
      image: pgmon,
